  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.socials}>
        <a href="https://instagram.com/camaluna" target="_blank" rel="noreferrer" className={styles.socialItem}>
          ...
          <div>
            ...
            <p className={styles.socialHandle}>@camaluna</p>
          </div>
        </a>

        <a href="https://wa.me/573107777579" target="_blank" rel="noreferrer" className={styles.socialItem}>
          ...
          <div>
            ...
            <p className={styles.socialHandle}>3107777579</p>
          </div>
        </a>
